package br.com.projetoAppium.core;
...
public class DriverFactory {
	...
	private static void createDriver() {
		...
		desiredCapabilities.setCapability("deviceName", "42009ec60184146f");
		desiredCapabilities.setCapability("automationName", "uiautomator2");
		desiredCapabilities.setCapability(MobileCapabilityType.APP,
				"/Users/wcaquino/Documents/dev/java/workspaceCurso/CursoAppium/src/main/resources/CTAppium_1_0.apk");
